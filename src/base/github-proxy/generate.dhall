...
let componentLabel = Util/component-label "github-proxy"
...
let Deployment/generate =
      λ(c : Configuration/global.Type) →
        ...
        let image =
              Optional/default
                Text
                "index.docker.io/sourcegraph/github-proxy:3.21.2@sha256:4b0f1d4b1675a768e3cfd6d3b43da97b67598c0dd8088513dbb35d6f8e620b9a"
                overrides.image
...
let Generate =
        ( λ(c : Configuration/global.Type) →
            { Deployment.github-proxy = Deployment/generate c
            , Service.github-proxy = Service/generate c
            }
        )
